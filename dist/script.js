...
function (_Slider) {
  ...
  function MainSlider(page, btns) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, page, btns)); // Метод чтобы получить доступ к свойствам класса
  }
...
var Slider = function Slider() {
  ...
  // Сюда помещаем те свойства слайдера, которые перед работой ему нужны
